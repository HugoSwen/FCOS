...
if __name__ == "__main__":
    ...
    eval_dataset = AircraftDataset("../dataset", mode='validate', resize_size=[512, 800])
    print("success creating eval_dataset...")
    print("eval_dataset has %d imgs..." % len(eval_dataset))
